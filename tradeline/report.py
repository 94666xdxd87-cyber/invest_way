...
def save_excel(
    ...
    """
    輸出含三張工作表的 Excel：
      Sheet1 每日明細　Sheet2 交易記錄　Sheet3 績效摘要
    """
    wb            = Workbook()
    ...
    param_str  = (f"MA={MA_PERIOD}, WIN={LOCAL_WIN}, TOL={TOLERANCE}, "
    ...
    title_c = ws3.cell(row=1, column=1, value=f"{display_name} 趨勢線策略 績效摘要")
